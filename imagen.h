...
bool imagen_pegar(imagen_t *destino, imagen_t *origen, size_t fila, size_t columna); // (9)

imagen_t *imagen_rotar(imagen_t *i); // (10)

void imagen_iniciar_color(imagen_t *i, color_t color); // (11)

size_t imagen_ancho(imagen_t *i); // (12)

size_t imagen_alto(imagen_t *i); // (13)
